    ...
    $out .='<ul class="slides-container">'."\n";
		...
		if(get_theme_mod('mk_slider_content','custom_slides') == 'latest_posts' ):
			...
			wp_reset_postdata();
				...
				$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide1_url', '#')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide1_btntext', 'Learn more')).'</a>'."\n";
				$out .='</article>'."\n";
				$out .='</li>'."\n";
				endif;
				...
				$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide2_url', '#')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide2_btntext', 'Learn more')).'</a>'."\n";
				$out .='</article>'."\n";
				$out .='</li>'."\n";
				 endif;
				...
				$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide3_url', 'https://gum.co/vpAOC')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide3_btntext', 'Learn more')).'</a>'."\n";
				$out .='</article>'."\n";
				$out .='</li>'."\n";
				endif;
				...
				$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide4_url', '#')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide4_btntext', 'Learn more')).'</a>'."\n";
				$out .='</article>'."\n";
				$out .='</li>'."\n";
				endif;
				...
				$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide5_url', '#')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide5_btntext', 'Learn more')).'</a>'."\n";
				$out .='</article>'."\n";
				$out .='</li>'."\n";
